	...
	function imgShowInit(){
		...
		$('#dPicListBody .ulSmallPic').width(allPic * 101)
		...
		function smallPicScroll() {
			if(curPic != preShowPic) {
				...
				if(curPic>2 && curPic<($("#dPicListBody .ulSmallPic li").length-3)) {
					leftPosition=-(curPic-2)*101;
				}else if(curPic > ($("#dPicListBody .ulSmallPic li").length-4) && $("#dPicListBody .ulSmallPic li").length>4) {
					leftPosition=-($("#dPicListBody .ulSmallPic li").length-4)*101;
				}
				leftPosition+="px";
		...
		$("#sLeftBtnB").click(function(){
			if($(this).attr("class")=="sLeftBtnBSel") {
				...
				leftPosition=leftPositionNum+101+"px";
				if(leftPosition=="0px") {if($(this).attr("class") != "sLeftBtnBBan") {$(this).attr("class","sLeftBtnBBan");}}
				var bestLeftNum=-($("#dPicListBody .ulSmallPic li").length-4)*101;
				if((leftPositionNum+101) > bestLeftNum && $("sRightBtnB").attr("class") != "sRightBtnB") {$("#sRightBtnB").attr("class","sRightBtnB")}
		...
		$("#sRightBtnB").click(function(){
			if($(this).attr("class")=="sRightBtnBSel"){
				...
				if($("#dPicListBody .ulSmallPic li").length <= 4){
				...
				if((leftPositionNum-101)<=bestLeftNum) {$(this).attr("class","sRightBtnBBan");}
			...
			btnBInitA();
			smallPicSelected();	
			$("#dPicListBody .ulSmallPic").css('left','0px');
